...
public class T1_Registration_Form {
    ...
    public void registration_form_test(){
        ...
        WebElement inputEmailName = Driver.getDriver().findElement(By.xpath("//input[@name='email']"));
        inputEmailName.sendKeys(user+"@email.com");
        ...
        Select departmentDropdown = new Select(Driver.getDriver().findElement(By.xpath("//input[@name='department']")));
